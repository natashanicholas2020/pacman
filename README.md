...
You **_must_** specify exactly one of the following:
jazmyn
natasha
kaitlyn
Example:
...
```
python vis*_acman.py train jazmyn
```
...
# 1. Train an agent yourself and visualize an evaluation episode

```
python vis_pacman.py train gui <name>
```
